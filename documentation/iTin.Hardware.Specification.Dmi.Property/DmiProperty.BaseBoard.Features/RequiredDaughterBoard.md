# DmiProperty.BaseBoard.Features.RequiredDaughterBoard property

Gets a value representing the key to retrieve the property value.

Indicates if mainboard required a daughter board.

Key Composition

* Structure: BaseBoard
* Property: RequiredDaughterBoard
* Unit: None
...
```csharp
public static IPropertyKey RequiredDaughterBoard { get; }
```
