# DmiProperty.ManagementDeviceComponent.ManagementDeviceHandle property

Gets a value representing the key to retrieve the property value.

Handle, or instance number, of the Management Device.

Key Composition

* Structure: ManagementDevice
* Property: ManagementDeviceHandle
* Unit: None
...
```csharp
public static IPropertyKey ManagementDeviceHandle { get; }
```
