# DmiProperty.MemoryDevice.ModuleManufacturerId property

Gets a value representing the key to retrieve the property.

The two-byte module manufacturer ID found in the SPD of this memory device.

Key Composition

* Structure: MemoryDevice
* Property: ModuleManufacturerId
* Unit: None
...
```csharp
public static IPropertyKey ModuleManufacturerId { get; }
```
