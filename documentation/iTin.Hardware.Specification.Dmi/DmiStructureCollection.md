...
| [GetProperties](DmiStructureCollection/GetProperties.md)(…) | Returns a value that contains the result of the operation. |
| [GetProperty](DmiStructureCollection/GetProperty.md)(…) | Returns a value that contains the result of the operation. Always returns the first appearance of the property |
