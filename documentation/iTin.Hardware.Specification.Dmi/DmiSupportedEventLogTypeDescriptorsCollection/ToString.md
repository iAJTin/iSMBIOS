# DmiSupportedEventLogTypeDescriptorsCollection.ToString method
...
Object String that represents the current class.
...
* class [DmiSupportedEventLogTypeDescriptorsCollection](../DmiSupportedEventLogTypeDescriptorsCollection.md)
