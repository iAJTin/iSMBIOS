...
namespace iTin.Core.Hardware.Specification.Dmi
{
    ...
    /// <inheritdoc/>
    /// <summary>
    /// Specialization of the <see cref="DmiBaseType{T}"/> class that contains the logic to decode the End Of Table (Type 127) structure.
    ...
    internal sealed class DmiType127 : DmiBaseType<SmbiosType127>
    {
        ...
        #region [public] DmiType127(SmbiosType127, int): Initializes a new instance of the class by specifying the structure information and the SMBIOS version
        /// <inheritdoc/>
        /// <summary>
