...
namespace iTin.Core.Hardware.Specification.Dmi
{
    ...
    public sealed class DmiMemoryControllerContainedElementCollection : ReadOnlyCollection<int>
    {
        ...
        /// <inheritdoc />
        /// <summary>
        /// Initialize a new instance of the class <see cref="T:iTin.Core.Hardware.Specification.Dmi.DmiMemoryControllerContainedElementCollection" />.
        /// </summary>
        ...
        /// </summary>
        /// <returns>
        /// Object <see cref="T:System.String" /> that represents the current <see cref="DmiMemoryControllerContainedElementCollection"/> class.
        /// </returns>
        /// <remarks>
