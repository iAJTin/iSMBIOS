...
namespace iTin.Core.Hardware.Specification.Smbios.Property
{
    ...
    public static partial class SmbiosProperty
    {
        ...
        public static class Bios
        {
            ...
            /// <summary>
            /// <para>Gets a value representing the key to retrieve the property.</para>
            /// <para>Size of the physical device containing the BIOS. Measured in <b>KB</b>.</para>
            /// <para>— Key Composition —————————————————</para>
            /// <para>Structure: <see cref="SmbiosStructure.Bios"/></para>
            ...
            /// <summary>
            /// <para>Gets a value representing the key to retrieve the property.</para>
            /// <para>BIOS characteristics byte 1 supports: <b>ACPI</b>, <b>USB</b>, <b>ATAPI ZIP</b>, etc.</para>
            /// <para>— Key Composition —————————————————</para>
            /// <para>Structure: <see cref="SmbiosStructure.Bios"/></para>
            ...
            /// <summary>
            /// <para>Gets a value representing the key to retrieve the property.</para>
            /// <para>BIOS characteristics byte 2 supports: <b>BIOS Boot Specification</b>, <b>UEFI</b>, etc.</para>
            /// <para>— Key Composition —————————————————</para>
            /// <para>Structure: <see cref="SmbiosStructure.Bios"/></para>
