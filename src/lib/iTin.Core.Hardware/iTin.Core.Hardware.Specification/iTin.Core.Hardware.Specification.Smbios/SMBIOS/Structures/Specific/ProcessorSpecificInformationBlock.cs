...
namespace iTin.Core.Hardware.Specification.Smbios
{
    ...
    public class ProcessorSpecificInformationBlock
    {
        ...
        /// </value>
        public RiskVProcessorSpecificData ProcessorSpecificData => ProcessorTypeValue < 0x06 ? RiskVProcessorSpecificData.NotImplemented : new RiskVProcessorSpecificData(_data.Extract(0x02, BlockLenght));
        #endregion
