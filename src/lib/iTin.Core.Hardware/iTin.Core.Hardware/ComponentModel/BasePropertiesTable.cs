...
namespace iTin.Core.Hardware.ComponentModel
{
    ...
    public class BasePropertiesTable : IList<KeyValuePair<IPropertyKey, object>>
    {
        ...
        /// </returns>
        public bool Contains(KeyValuePair<IPropertyKey, object> item) => _table.Contains(item);
        #endregion
        ...
        #region [public] (IEnumerator<KeyValuePair<IPropertyKey, object>>) GetEnumerator(): Returns an enumerator that processes an iteration in the collection
        /// <inheritdoc />
        /// <summary>
        ...
        /// </returns>
        public IEnumerator<KeyValuePair<IPropertyKey, object>> GetEnumerator() => _table.GetEnumerator();
        #endregion

        #region [public] (bool) Remove(KeyValuePair<IPropertyKey, object>): Remove the first occurrence of a specific object from the ICollection interface
        /// <inheritdoc />
        /// <summary>
