...
namespace iTin.Core.Interop.Windows.Development.Graphics.Legacy.Gdi.DeviceContext
{
    ...
    /// <summary>
    /// The <strong>DISPLAY_DEVICE</strong> structure receives the display device information specified by the <c>iDevNum</c> parameter of the <see cref="NativeMethods.EnumDisplayDevices" /> function.
    /// </summary>
    /// <remarks>
