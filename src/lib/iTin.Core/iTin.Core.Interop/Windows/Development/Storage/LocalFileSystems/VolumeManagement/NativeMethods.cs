...
namespace iTin.Core.Interop.Windows.Development.Storage.LocalFileSystems.VolumeManagement
{
    ...
    /// Un volumen contiene al menos una partición, lo cual es una división lógica de un disco físico (para obtener más información, vea Dispositivos de discos y particiones en http://msdn.microsoft.com/en-us/library/aa363966%28v=VS.85%29.aspx).
    /// Un volumen que contiene los datos que existen en una partición que se llama un volumen simple, y un volumen
    /// que contiene los datos que existen en más de una partición que se llama un volumen de varias particiones.  
    /// </summary>
