...
namespace iTin.Core.Interop.Windows.Development.UI.WindowsAndMessages.Configuration
{
    ...
    public static class NativeMethods
    {
        ...
        #region [public] (enum) SystemMetricIndex: Represents a feature or configuration value of the system to recover
        /// <summary>
        /// Represents a feature or configuration value of the system to recover.
        /// Note that all <b>SM_CX*</b> values are wide and <b>SM_CY*</b> height values.
        /// Also note that the settings designed to return data <see cref="T:System.Boolean"/>, the value <b>true</b>
        /// is represented with a non-zero value and <b>false</b> with zero value.
        /// </summary>
        public enum SystemMetricIndex
        {
            /// <summary>
            /// Screen width of the main screen monitor, in pixels.
            /// This value is the same value that is obtained by calling <b>GetDeviceCaps</b> as follows: GetDeviceCaps (hdcPrimaryMonitor, HORZRES).
            /// </summary>
            SM_CXSCREEN = 0,

            /// <summary>
            /// Screen height of the main screen monitor, in pixels.
            /// This value is the same value that is obtained by calling <b>GetDeviceCaps</b> as follows: GetDeviceCaps (hdcPrimaryMonitor, VERTRES).
            /// </summary>
            SM_CYSCREEN = 1,
            ...
            /// <summary>
            /// Title area height, in pixels.
            /// </summary>
            SM_CYCAPTION = 4,

            /// <summary>
            /// Window border width, in pixels. This is equivalent to the value <see cref="SM_CXEDGE"/> for windows with the 3D appearance.
            /// </summary>
            SM_CXBORDER = 5,
            ...
            /// <summary>
            /// Please see, <see cref="SM_CXFIXEDFRAME"/>.
            /// </summary>
            SM_CXDLGFRAME = 7,
            ...
            /// <summary>
            /// Height of a one-line menu bar, in pixels.
            /// </summary>
            SM_CYMENU = 15,
            ...
            /// <summary>
            /// Width of a button on a bar or window title, in pixels.
            /// </summary>
            SM_CXSIZE = 30,

            /// <summary>
            /// Height of a button on a bar or window title, in pixels.
            /// </summary>
            SM_CYSIZE = 31,
            ...
            /// <summary>
            /// Number of mouse buttons, returns zero if the mouse is not installed.
            /// </summary>
            SM_CMOUSEBUTTONS = 43,
            ...
            /// <summary>
            /// Number of monitors on a computer screen. For more information, see the Comments section of this topic.
            /// </summary>
            SM_CMONITORS = 80,
            ...
            /*#else*/
            /// <summary>
            /// A nonzero value indicates that the current operating system is Windows 7 Starter Edition, Windows Vista Starter or Windows XP Starter Edition; otherwise, 0.
            /// </summary>
            SM_CMETRICS_NT = 88,
        ...
        #region [public] (enum) SPI: Represents a feature or configuration value of the system to recover
        /// <summary>
        /// Represents a feature or configuration value of the system to recover.
        /// Note that all <b>SM_CX*</b> values are wide and <b>SM_CY*</b> height values.
        /// Also note that the settings designed to return data <see cref="T: System.Boolean"/>, the value <b>true</b> is represented with a non-zero value and <b>false</b> with zero value.
        /// </summary>            
        ...
        public enum SPI : uint
        {
            ...
            /// <summary>
            /// Determine if full window dragging is enabled (view content when dragging).
            /// The <b>pvParam</b> parameter must point to a variable of type <see cref="T:System.Boolean"/> that will receive <b>true</b> if the feature is activated or <b>false</b> otherwise.
            /// </summary>
            GetIconTitleWrap = 0x0019,

            /// <summary>
            /// Activate or deactivate the feature. See <see cref="GetIconTitleWrap" />.
            /// </summary>
            ...
            /// <summary>
            /// Activate or deactivate the feature. See <see cref="GetDragFullWindows"/>.
            /// </summary>
            SetDragFullWindows = 0x0025,

            /// <summary>
            /// Determine if full window dragging is enabled (view content when dragging).
            /// The <strong> pvParam </strong> parameter must point to a variable of type <see cref="T:System.Boolean"/> that will receive <b>true</b>
            /// if the feature is activated or <b>false</b> otherwise.
            /// </summary>
            /// <remarks>
            /// For Windows 95, this feature is only supported if you have Windows Plus! See <see cref="GetWindowsExtension"/>.
            /// </remarks>
            ...
            /// <summary>
            /// Determines whether the font smoothing function is enabled.
            ...
            /// <summary>
            /// Activate or deactivate the feature. See <see cref="GetFontSmoothing"/>.
            /// </summary>
            ...
            /// <summary>
            /// Activate or deactivate the feature. See <see cref="GetHotTracking"/>.
            /// </summary>
            ...
            /// <summary>
            /// Activate or deactivate the feature. See <see cref="GetMenuFade"/>.
            /// </summary>
            SetMenuFade = 0x1013,
            ...
            /// <summary>
            /// Activate or deactivate the feature. See <see cref="GetSelectionFade"/>.
            /// </summary>
            ...
            /// <summary>
            /// Activate or deactivate the feature. See <see cref="GetTooltipAnimation"/>.
            /// </summary>
            ...
            /// <summary>
            /// Activate or deactivate the feature. See <see cref="GetTooltipFade"/>.
            /// </summary>
            ...
            /// <summary>
            /// Activate or deactivate the feature. See <see cref="GetCursorShadow"/>.
            /// </summary>
        ...
        #region [public] (enum) SPIF: Represents a feature or configuration value of the system to recover
        /// <summary>
        /// Specify whether it is necessary to update the user profile, and if so, indicate that the message <b>WM_SETTINGCHANGE</b> is sent to all upper level windows to notify them of the change.
        /// This parameter can be zero if you do not want to update the user profile or the <b>WM_SETTINGCHANGE</b> message, or it can be one or more of the following values.
        /// </summary>
        [Flags]
        public enum SPIF
        {
            ...
            /// <summary>
            ///	Write the new parameter value in the user profile.
            /// </summary>      
            UpdateIniFile = 0x01,

            /// <summary>
            /// Send message <b>WM_SETTINGCHANGE</b> after updating the user profile.
            /// </summary>      
            SendChange = 0x02,

            /// <summary>
            /// Same as option <see cref="SendChange"/>.
            /// </summary>
        ...
        #region [public] {static} (int) GetSystemMetrics(SystemMetricIndex):  Retrieves a configuration value or a system characteristic
        /// <summary>
        /// Retrieves a configuration value or a system characteristic.
        /// All measurement values obtained by <b>GetSystemMetrics</b> are in pixels. For more information, please see http://msdn.microsoft.com/en-us/library/ms724385%28v=VS.85%29.aspx.
        /// </summary>
        [DllImport(ExternDll.Win.User32, ExactSpelling = true)]
        public static extern int GetSystemMetrics(SystemMetricIndex smIndex);
        #endregion

        #region [public] {static} (bool) SystemParametersInfo(SPI, uint, IntPtr, SPIF): Retrieves or sets the value of one of the system parameters
        /// <summary>
        /// Retrieves or sets the value of one of the system parameters.
        /// This function can also update the user profile by setting a parameter. For more information, please see http://msdn.microsoft.com/en-us/library/ms724947%28v=VS.85%29.aspx.
        /// </summary>
        ...
        #region [public] {static} (bool) SystemParametersInfo(SPI, uint, ref Boolean, SPIF): Retrieves or sets the value of one of the system parameters
        /// <summary>
        /// Retrieves or sets the value of one of the system parameters.
        /// This function can also update the user profile by setting a parameter. For more information, please see http://msdn.microsoft.com/en-us/library/ms724947%28v=VS.85%29.aspx.
        /// </summary>
        [DllImport(ExternDll.Win.User32, CharSet = CharSet.Unicode, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool SystemParametersInfo(SPI uiAction, uint uiParam, [MarshalAs(UnmanagedType.Bool)] ref bool pvParam, SPIF fWinIni);
        #endregion

        #region [public] {static} (bool) SystemParametersInfo(SPI, uint, Boolean, SPIF): Retrieves or sets the value of one of the system parameters
        /// <summary>
        /// Retrieves or sets the value of one of the system parameters.
        /// This function can also update the user profile by setting a parameter. For more information, please see http://msdn.microsoft.com/en-us/library/ms724947%28v=VS.85%29.aspx.
        /// </summary>
        [DllImport(ExternDll.Win.User32, CharSet = CharSet.Unicode, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool SystemParametersInfo(SPI uiAction, uint uiParam, [MarshalAs(UnmanagedType.Bool)] bool pvParam, SPIF fWinIni);
        #endregion

        #region [public] {static} (bool) SystemParametersInfo(SPI, uint, string, SPIF): Retrieves or sets the value of one of the system parameters
        /// <summary>
        /// Retrieves or sets the value of one of the system parameters.
        /// This function can also update the user profile by setting a parameter. For more information, please see http://msdn.microsoft.com/en-us/library/ms724947%28v=VS.85%29.aspx.
        /// </summary>
        ...
        #region [public] {static} (bool) SystemParametersInfo(SPI, uint, ref ANIMATIONINFO, SPIF): Retrieves or sets the value of one of the system parameters
        /// <summary>
        /// Retrieves or sets the value of one of the system parameters.
        /// This function can also update the user profile by setting a parameter. For more information, please see http://msdn.microsoft.com/en-us/library/ms724947%28v=VS.85%29.aspx.
        /// </summary>
