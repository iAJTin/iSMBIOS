...
namespace iTin.Core.Interop.Windows.Development.UI.WindowsAndMessages.Configuration
{
    ...
    internal static class NativeMethods
    {
        ...
        /// Este parámetro puede ser cero si no desea actualizar el perfil de usuario o el mensaje de <strong>WM_SETTINGCHANGE</strong>, o puede ser uno o más de los siguientes valores.
        /// </summary>
        [Flags]
        internal enum SPIF
        {
