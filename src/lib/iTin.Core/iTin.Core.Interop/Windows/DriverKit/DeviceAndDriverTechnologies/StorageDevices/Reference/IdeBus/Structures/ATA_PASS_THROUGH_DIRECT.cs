...
{
    /// <summary>
    /// La estructura <strongs>ATA_PASS_THROUGH_DIRECT</strongs> contiene los parámetros de entrada para una petición de tipo <see cref="IOCTL_ATA_PASS_THROUGH_DIRECT"/>.
    /// </summary>
    /// <remarks>
    /// Para más información, ver http://msdn.microsoft.com/en-us/library/ff551322%28v=VS.85%29.aspx
    /// </remarks>
