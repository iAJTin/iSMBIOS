...
namespace iTin.Core.Interop.Windows.Hardware.DriverKit.Storage.Ata
{
    ...
    /// <summary>
    /// The <strongs>ATA_PASS_THROUGH_DIRECT</strongs> structure is used in conjunction with an <see cref="IdeIoControlCode.IOCTL_ATA_PASS_THROUGH_DIRECT"/> request to instruct the port driver to send an embedded ATA command to the target device.
    /// </summary>
    /// <remarks>
    /// For more information, please see https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/ntddscsi/ns-ntddscsi-_ata_pass_through_direct.
    /// </remarks>
