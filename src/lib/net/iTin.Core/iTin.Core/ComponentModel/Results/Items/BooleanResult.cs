...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class BooleanResult : ResultBase<bool>
    {
        ...
        /// A new invalid <see cref="BooleanResult"/> with specified detailed error.
        /// </returns>
        public new static BooleanResult CreateErroResult(string message, bool value, string code = "") => CreateErroResult(new IResultError[] { new ResultError { Code = code, Message = message } }, value);
        ...
        /// A new invalid <see cref="BooleanResult"/> with specified detailed errors collection.
        /// </returns>
        public new static BooleanResult CreateErroResult(IResultError[] errors, bool value) =>
            new BooleanResult
            {
                Value = value,
                Success = false,
        ...
        /// A new <see cref="BooleanResult"/> instance for specified exception.
        /// </returns>
        public new static BooleanResult FromException(Exception exception, bool value) =>
            new BooleanResult
            {
                Value = value,
                Success = false,
