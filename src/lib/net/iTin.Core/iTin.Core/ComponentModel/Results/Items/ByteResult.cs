...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class ByteResult : ResultBase<byte>
    {
        ...
        /// A new invalid <see cref="ByteResult"/> with specified detailed error.
        /// </returns>
        public new static ByteResult CreateErroResult(string message, byte value, string code = "") => CreateErroResult(new IResultError[] { new ResultError { Code = code, Message = message } }, value);
        ...
        /// A new invalid <see cref="ByteResult"/> with specified detailed errors collection.
        /// </returns>
        public new static ByteResult CreateErroResult(IResultError[] errors, byte value) =>
            new ByteResult
            {
                Value = value,
                Success = false,
        ...
        /// A new <see cref="ByteResult"/> instance for specified exception.
        /// </returns>
        public new static ByteResult FromException(Exception exception, byte value) =>
            new ByteResult
            {
                Value = value,
                Success = false,
