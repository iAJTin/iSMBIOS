...
{
    /// <summary>
    /// Specialization of the interface <see cref="ResultBase{T}" /> that contains a <see cref="T:System.Decimal"/> result.
    /// </summary>
    public class DecimalResult : ResultBase<decimal>
    {
        ...
        /// </returns>
        public new static DecimalResult CreateErrorResult(string message, string code = "") => 
        ...
        /// A new invalid <see cref="DecimalResult"/> with specified detailed error.
        /// </returns>
        public new static DecimalResult CreateErrorResult(string message, decimal result, string code = "") => 
        ...
        /// </returns>
        public new static DecimalResult FromException(Exception exception) => 
