...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class DoubleResult : ResultBase<double>
    {
        ...
        /// A new invalid <see cref="DoubleResult"/> with specified detailed error.
        /// </returns>
        public new static DoubleResult CreateErroResult(string message, double value, string code = "") => CreateErroResult(new IResultError[] { new ResultError { Code = code, Message = message } }, value);
        ...
        /// A new invalid <see cref="DoubleResult"/> with specified detailed errors collection.
        /// </returns>
        public new static DoubleResult CreateErroResult(IResultError[] errors, double value) =>
            new DoubleResult
            {
                Value = value,
                Success = false,
        ...
        /// A new <see cref="DoubleResult"/> instance for specified exception.
        /// </returns>
        public new static DoubleResult FromException(Exception exception, double value) =>
            new DoubleResult
            {
                Value = value,
                Success = false,
