...
{
    /// <summary>
    /// Specialization of the interface <see cref="ResultBase{T}" /> that contains a <see cref="T:System.Single"/> result.
    /// </summary>
    public class FloatResult : ResultBase<float>
    {
        ...
        /// </returns>
        public new static FloatResult CreateErrorResult(string message, string code = "") => 
        ...
        /// A new invalid <see cref="FloatResult"/> with specified detailed error.
        /// </returns>
        public new static FloatResult CreateErrorResult(string message, float result, string code = "") => 
        ...
        /// </returns>
        public new static FloatResult FromException(Exception exception) => 
