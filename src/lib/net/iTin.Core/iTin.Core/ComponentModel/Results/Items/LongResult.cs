...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class LongResult : ResultBase<long>
    {
        ...
        /// A new invalid <see cref="LongResult"/> with specified detailed error.
        /// </returns>
        public new static LongResult CreateErroResult(string message, long value, string code = "") => CreateErroResult(new IResultError[] { new ResultError { Code = code, Message = message } }, value);
        ...
        /// A new invalid <see cref="LongResult"/> with specified detailed errors collection.
        /// </returns>
        public new static LongResult CreateErroResult(IResultError[] errors, long value) =>
            new LongResult
            {
                Value = value,
                Success = false,
        ...
        /// </returns>
        public new static LongResult CreateSuccessResult(long value) =>
            new LongResult
            {
                Value = value,
                Success = true,
        ...
        /// A new <see cref="LongResult"/> instance for specified exception.
        /// </returns>
        public new static LongResult FromException(Exception exception, long value) =>
            new LongResult
            {
                Value = value,
                Success = false,
