...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class NullableBooleanResult : ResultBase<bool?>
    {
        ...
        /// </returns>
        public new static NullableBooleanResult CreateErrorResult(string message, string code = "") => 
        ...
        /// A new invalid <see cref="NullableBooleanResult"/> with specified detailed error.
        /// </returns>
        public new static NullableBooleanResult CreateErrorResult(string message, bool? result, string code = "") => 
        ...
        /// </returns>
        public new static NullableBooleanResult FromException(Exception exception) => 
