...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class NullableDecimalResult : ResultBase<decimal?>
    {
        ...
        /// A new invalid <see cref="NullableDecimalResult"/> with specified detailed error.
        /// </returns>
        public new static NullableDecimalResult CreateErroResult(string message, decimal? value, string code = "") => CreateErroResult(new IResultError[] { new ResultError { Code = code, Message = message } }, value);
        ...
        /// A new invalid <see cref="NullableDecimalResult"/> with specified detailed errors collection.
        /// </returns>
        public new static NullableDecimalResult CreateErroResult(IResultError[] errors, decimal? value) =>
            new NullableDecimalResult
            {
                Value = value,
                Success = false,
        ...
        /// A new <see cref="NullableDecimalResult"/> instance for specified exception.
        /// </returns>
        public new static NullableDecimalResult FromException(Exception exception, decimal? value) =>
            new NullableDecimalResult
            {
                Value = value,
                Success = false,
