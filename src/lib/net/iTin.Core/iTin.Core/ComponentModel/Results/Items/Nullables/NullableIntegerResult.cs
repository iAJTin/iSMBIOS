...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class NullableIntegerResult : ResultBase<int?>
    {
        ...
        /// </returns>
        public new static NullableIntegerResult CreateErrorResult(string message, string code = "") => 
        ...
        /// A new invalid <see cref="NullableIntegerResult"/> with specified detailed error.
        /// </returns>
        public new static NullableIntegerResult CreateErrorResult(string message, int? result, string code = "") => 
        ...
        /// </returns>
        public new static NullableIntegerResult FromException(Exception exception) => 
