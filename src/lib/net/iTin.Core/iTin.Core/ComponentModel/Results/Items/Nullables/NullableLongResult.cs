...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class NullableLongResult : ResultBase<long?>
    {
        ...
        /// </returns>
        public new static NullableLongResult CreateErrorResult(string message, string code = "") => 
        ...
        /// A new invalid <see cref="NullableLongResult"/> with specified detailed error.
        /// </returns>
        public new static NullableLongResult CreateErrorResult(string message, long? result, string code = "") => 
        ...
        /// </returns>
        public new static NullableLongResult FromException(Exception exception) =>
