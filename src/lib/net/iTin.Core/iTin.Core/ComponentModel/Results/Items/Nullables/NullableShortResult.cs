...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class NullableShortResult : ResultBase<short?>
    {
        ...
        /// A new invalid <see cref="NullableShortResult"/> with specified detailed error.
        /// </returns>
        public new static NullableShortResult CreateErroResult(string message, short? value, string code = "") => CreateErroResult(new IResultError[] { new ResultError { Code = code, Message = message } }, value);
        ...
        /// A new invalid <see cref="NullableShortResult"/> with specified detailed errors collection.
        /// </returns>
        public new static NullableShortResult CreateErroResult(IResultError[] errors, short? value) =>
            new NullableShortResult
            {
                Value = value,
                Success = false,
        ...
        /// A new <see cref="NullableShortResult"/> instance for specified exception.
        /// </returns>
        public new static NullableShortResult FromException(Exception exception, short? value) =>
            new NullableShortResult
            {
                Value = value,
                Success = false,
