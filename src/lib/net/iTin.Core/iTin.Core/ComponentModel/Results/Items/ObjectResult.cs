...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class ObjectResult : ResultBase<object>
    {
        ...
        /// A new invalid <see cref="ObjectResult"/> with specified detailed error.
        /// </returns>
        public new static ObjectResult CreateErroResult(string message, object value, string code = "") => CreateErroResult(new IResultError[] { new ResultError { Code = code, Message = message } }, value);
        ...
        /// A new invalid <see cref="ObjectResult"/> with specified detailed errors collection.
        /// </returns>
        public new static ObjectResult CreateErroResult(IResultError[] errors, object value) =>
            new ObjectResult
            {
                Value = value,
                Success = false,
        ...
        /// A new <see cref="ObjectResult"/> instance for specified exception.
        /// </returns>
        public new static ObjectResult FromException(Exception exception, object value) =>
            new ObjectResult
            {
                Value = value,
                Success = false,
