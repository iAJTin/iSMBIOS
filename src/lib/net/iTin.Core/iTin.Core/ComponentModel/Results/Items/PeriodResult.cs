...
{
    /// <summary>
    /// Specialization of the interface <see cref="ResultBase{T}" /> that contains a <see cref="Period"/> result.
    /// </summary>
    public class PeriodResult : ResultBase<Period>
    {
        ...
        /// </returns>
        public new static PeriodResult CreateErrorResult(string message, string code = "") => 
        ...
        /// A new invalid <see cref="PeriodResult"/> with specified detailed error.
        /// </returns>
        public new static PeriodResult CreateErrorResult(string message, Period result, string code = "") =>
        ...
        /// </returns>
        public new static PeriodResult FromException(Exception exception) =>
