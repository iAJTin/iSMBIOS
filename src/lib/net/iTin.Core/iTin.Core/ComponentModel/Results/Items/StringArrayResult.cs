...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class StringArrayResult : ResultBase<string[]>
    {
        ...
        /// </returns>
        public new static StringArrayResult CreateErrorResult(string message, string code = "") => 
        ...
        /// A new invalid <see cref="StringArrayResult"/> with specified detailed error.
        /// </returns>
        public new static StringArrayResult CreateErrorResult(string message, string[] result, string code = "") => 
        ...
        /// </returns>
        public new static StringArrayResult FromException(Exception exception) => 
