...
public class ConsoleMapping
{
    ...
    /// </summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public static readonly ConsoleMapping DefaultFatalMapping = new() { Level = LogLevel.Fatal, Pattern = KnownPatterns.DefaultFatalPattern };

    /// <summary>
    /// Returns new instance of <see cref="ConsoleMapping"/> configured for <b>Error</b> log level.
    /// </summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public static readonly ConsoleMapping DefaultErrorMapping = new() { Level = LogLevel.Error, Pattern = KnownPatterns.DefaultErrorPattern };

    /// <summary>
    /// Returns new instance of <see cref="ConsoleMapping"/> configured for <b>Info</b> log level.
    /// </summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public static readonly ConsoleMapping DefaultInfoMapping = new() { Level = LogLevel.Info, Pattern = KnownPatterns.DefaultPattern };

    /// <summary>
    /// Returns new instance of <see cref="ConsoleMapping"/> configured for <b>Debug</b> log level.
    /// </summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public static readonly ConsoleMapping DefaultDebugMapping = new() { Level = LogLevel.Debug, Pattern = KnownPatterns.DefaultPattern };

    /// <summary>
    /// Returns new instance of <see cref="ConsoleMapping"/> configured for <b>Warn</b> log level.
    /// </summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public static readonly ConsoleMapping DefaultWarnMapping = new() { Level = LogLevel.Warn, Pattern = KnownPatterns.DefaultPattern };
